...
<%!String title1,About,category,fname; %>
...
String myquery="INSERT INTO VAIDHYANATHAN.DOCUMENTS (DOCNAME, DOCID, PROFILETYPE, DOCDESCRIPTION, LIKES, DISLIKE, CATEGORY, EMAILID, TIMESTAMP) VALUES (?,?,?,?,?,?,?,?,?)";
likes=0;
dislikes=0;
