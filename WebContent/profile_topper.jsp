...
String getsql="SELECT * FROM VAIDHYANATHAN.USER_TOPPER WHERE USERID=?" ;
...
experience=rs.getString("experience").toString();
...
<tr> <td id="Left"> Experience </td> <td id="Right" style="width:100px; word-wrap:break-word"><%=experience %>  </td> </tr>
...
String photourl="images/" + session.getAttribute("profilepic").toString(); %>
...
ResultSet docrs;
conn=DriverManager.getConnection("jdbc:db2://localhost:50000/MEGADEUS","Vaidhyanathan","72zwbn");
String docsql="SELECT * FROM VAIDHYANATHAN.DOCUMENTS AS DOCUMENTS WHERE DOCUMENTS.EMAILID=? ORDER BY DOCUMENTS.TIMESTAMP DESC" ;
PreparedStatement doc=conn.prepareStatement(docsql);

doc.setString(1, emailid);
