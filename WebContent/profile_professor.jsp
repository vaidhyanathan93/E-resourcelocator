...
String getsql="SELECT * FROM VAIDHYANATHAN.USER_PROFESSOR WHERE USERID=?" ;
...
ResultSet docrs;
conn=DriverManager.getConnection("jdbc:db2://localhost:50000/MEGADEUS","Vaidhyanathan","72zwbn");
String docsql="SELECT * FROM VAIDHYANATHAN.BOOKS AS BOOKS WHERE BOOKS.EMAILID=? ORDER BY BOOKS.TIMESTAMP DESC" ;
