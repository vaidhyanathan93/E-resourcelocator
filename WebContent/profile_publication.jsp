...
String getsql="SELECT * FROM VAIDHYANATHAN.USER_PUBLICATION WHERE USERID=?" ;
...
<tr> <td id="Left"> Started ON </td> <td id="Right"> <%=pdate  %></td> </tr>
...
<b style="color:#140F55;"><%=name  %></b> <br/><%=city %><br/> <%=country %> <br/>
 ...
 <a href="publication_upload.jsp">Upload a BOOK</a>
