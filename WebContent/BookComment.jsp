...
ResultSet rs=null,rs1=null,rs2=null;
	 ...
	 String query="Select USERID,BOOK_COMMENT from VAIDHYANATHAN.BOOKS_COMMENT where BOOKID='"+BOOKID+"'";
	 //
	 	 Class.forName("com.ibm.db2.jcc.DB2Driver").newInstance();	 
	...
	// refString= rs.getString("USERID").toString()+","+ Integer.toString(rs.getInt("COUNT"));
